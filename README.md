...
MYSQL_PORT=3306
MYSQL_DATABASE=teste2
MYSQL_USERNAME=root
MYSQL_PASSWORD=sua_senha
```

> O arquivo `.env` não é versionado. As configurações são carregadas automaticamente via [spring-dotenv](https://github.com/paulschwarz/spring-dotenv).
